...
population |> mutate(state_name = reorder_within(state_name, population, year)) |> ggplot(aes(x = population, y = state_name)) + geom_col() + coord_flip() + facet_wrap(~year, scales = "free_y") + scale_y_reordered()
